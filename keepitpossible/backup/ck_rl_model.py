...
MIN_BATCH_SIZE = N_WORKER * UPDATE_STEP * 3

# 設定輸入的維度
image_features, action_dim = 84672, 1
#限制控制，提高收斂程度
ACTION_BOUND = [6,12]
...
if __name__ == '__main__':
    ...
    workers = [Worker(envpath='./ObstacleTower/obstacletower.x86_64',
                      wid=i,
                      retro=False,
                      realtime_mode=False,
                      env_seed=np.random.randint(10),
