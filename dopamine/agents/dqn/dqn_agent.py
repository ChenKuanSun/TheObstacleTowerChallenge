...
NATURE_DQN_OBSERVATION_SHAPE = unity_lib.NATURE_DQN_OBSERVATION_SHAPE
NATURE_DQN_DTYPE = unity_lib.NATURE_DQN_DTYPE
NATURE_DQN_STACK_SIZE = unity_lib.NATURE_DQN_STACK_SIZE
nature_dqn_network = unity_lib.nature_dqn_network
...
class DQNAgent(object):
  ...
  def __init__(self,
               sess,
               num_actions,
               observation_shape=unity_lib.NATURE_DQN_OBSERVATION_SHAPE,
               observation_dtype=unity_lib.NATURE_DQN_DTYPE,
               stack_size=unity_lib.NATURE_DQN_STACK_SIZE,
               network=unity_lib.nature_dqn_network,
               gamma=0.99,
               update_horizon=3,
  ...
  def unbundle(self, checkpoint_dir, iteration_number, bundle_dictionary):
    ...
    try:
      ...
      self._replay.load = lambda _1, _2: True
